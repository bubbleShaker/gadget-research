...
```mermaid
flowchart TD
    A[iPhone 連携で睡眠・心拍を測りたい] --> B{時計型である必要がある?}
    B -->|いいえ| Z[Oura Ring 4 / WHOOP 5.0<br/>睡眠精度は最上位・サブスク必須]
    B -->|はい| C{毎日充電できる?}
    C -->|面倒・忘れそう| D[Garmin]
    C -->|できる| E{ECG・高血圧通知が欲しい?}
    E -->|はい| F[Apple Watch Series 11<br/>64,800円〜]
    E -->|いいえ| G[Apple Watch SE 3<br/>37,800円〜]
    D --> H{睡眠分析の深さ vs 予算}
    H -->|軽さと価格重視| I[vívoactive 6<br/>52,800円]
    H -->|呼吸モニタ・睡眠コーチ重視| J[Venu 4<br/>79,800円]
```
